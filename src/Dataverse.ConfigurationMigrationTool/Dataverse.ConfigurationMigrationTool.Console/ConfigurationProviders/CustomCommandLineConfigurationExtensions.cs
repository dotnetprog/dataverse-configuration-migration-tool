...
{
    /// <summary>
    ///   Adds a <see cref="CustomCommandLineConfigurationProvider"/> <see cref="IConfigurationProvider"/>
    ...
    /// <summary>
    ///   Adds a <see cref="CustomCommandLineConfigurationProvider"/> <see cref="IConfigurationProvider"/> that reads
    ...
    public static IConfigurationBuilder AddCustomCommandline(
        ...
        string[] args,
        IDictionary<string, string>? switchMappings, IEnumerable<string>? flagMappings)
    {
    ...
    /// <returns>The <see cref="IConfigurationBuilder"/>.</returns>
    public static IConfigurationBuilder AddCustomCommandline(this IConfigurationBuilder builder, Action<CustomCommandLineConfigurationSource>? configureSource)
